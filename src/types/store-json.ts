export interface StoreJson {
 ...
 export type SdkRequestType = AuthCustomerAuthProvider | AuthCustomerAuthProviderCallback | AuthCustomerAuthProviderRegister | AuthCustomerAuthProviderResetPassword | AuthCustomerAuthProviderUpdate | AuthSession | AuthTokenRefresh | StoreCarts | StoreCartsId | StoreCartsIdComplete | StoreCartsIdCustomer | StoreCartsIdLineItems | StoreCartsIdLineItemsLineId | StoreCartsIdPromotions | StoreCartsIdShippingMethods | StoreCartsIdTaxes | StoreCollections | StoreCollectionsId | StoreCurrencies | StoreCurrenciesCode | StoreCustomers | StoreCustomersMe | StoreCustomersMeAddresses | StoreCustomersMeAddressesAddressId | StoreOrders | StoreOrdersId | StoreOrdersIdTransferAccept | StoreOrdersIdTransferCancel | StoreOrdersIdTransferDecline | StoreOrdersIdTransferRequest | StorePaymentCollections | StorePaymentCollectionsIdPaymentSessions | StorePaymentProviders | StoreProductCategories | StoreProductCategoriesId | StoreProductTags | StoreProductTagsId | StoreProductTypes | StoreProductTypesId | StoreProducts | StoreProductsId | StoreRegions | StoreRegionsId | StoreReturnReasons
